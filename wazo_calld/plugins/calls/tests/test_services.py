...
class TestServices(TestCase):
    ...
    def setUp(self):
        ...
        self.example_to_fit = {'type': 'ChannelDestroyed', 'timestamp': '2021-06-15T11:06:46.331-0400', 'cause': 3, 'cause_txt': 'No route to destination', 'channel': {'id': '1623769434.135', 'name': 'PJSIP/HwnelF4k-00000075', 'state': 'Up', 'caller': {'name': 'Oxynor', 'number': '9000'}, 'connected': {'name': 'Xelanir', 'number': '9001'}, 'accountcode': '', 'dialplan': {'context': 'pickup', 'exten': 'my_pickup', 'priority': 3, 'app_name': '', 'app_data': ''}, 'creationtime': '2021-06-15T11:06:45.465-0400', 'language': 'en_US', 'channelvars': {'CHANNEL(linkedid)': '1623743605.135', 'WAZO_CALL_RECORD_ACTIVE': '', 'WAZO_DEREFERENCED_USERUUID': '', 'WAZO_ENTRY_CONTEXT': 'default-key-2354-internal', 'WAZO_ENTRY_EXTEN': '9001', 'WAZO_LINE_ID': '2', 'WAZO_SIP_CALL_ID': 'coNsbzfk_Tcq2cffBi9g7Q..', 'WAZO_SWITCHBOARD_QUEUE': '', 'WAZO_SWITCHBOARD_HOLD': '', 'WAZO_TENANT_UUID': '6345gd34-9ac7-4337-818d-d04e606d9f74', 'XIVO_BASE_EXTEN': '9001', 'XIVO_ON_HOLD': '', 'XIVO_USERUUID': '76f7fmfh-a547-4324-a521-e2e04843cfee', 'WAZO_LOCAL_CHAN_MATCH_UUID': '', 'WAZO_CALL_RECORD_SIDE': 'caller'}}, 'asterisk_id': '52:54:00:2a:da:g5', 'application': 'callcontrol'}
