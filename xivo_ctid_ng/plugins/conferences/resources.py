...
class ParticipantMuteResource(AuthResource):
    ...
    @required_acl('ctid-ng.conferences.{conference_id}.participants.{participant_id}.mute.update')
...
class ParticipantUnmuteResource(AuthResource):
    ...
    @required_acl('ctid-ng.conferences.{conference_id}.participants.{participant_id}.unmute.update')
    def put(self, conference_id, participant_id):
        tenant = Tenant.autodetect()
