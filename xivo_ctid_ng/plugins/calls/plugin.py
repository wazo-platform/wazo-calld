...
class Plugin(object):
    ...
    def load(self, dependencies):
        ...
        bus_collectd_publisher = dependencies['bus_collectd_publisher']
        ...
        calls_stasis = CallsStasis(ari.client, bus_collectd_publisher, bus_publisher, calls_service, config['uuid'])
        calls_stasis.subscribe()

        calls_bus_event_handler = CallsBusEventHandler(ari.client, bus_collectd_publisher, bus_publisher, calls_service, config['uuid'])
